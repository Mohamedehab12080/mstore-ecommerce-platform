...
│   ├── lib-bom/                      # Library Bill of Materials
│   ├── common/                       # Common utilities
│   ├── security/                     # Security components
│   ├── database/                     # Database utilities
│   ├── messaging/                    # Messaging components
│   ├── cache/                        # Caching components
│   ├── user-adapter/                 # User management adapters
│   ├── product-adapter/              # Product management adapters
│   └── workflow-engine/              # Workflow management
├── service/                          # Business services
│   ├── service-bom/                  # Service Bill of Materials
...
│       ├── discount/                 # Discount & promotion service
│       ├── notification/             # Notification service
│       ├── review/                   # Product review service
│       └── shipping/                 # Shipping service
├── ms/                               # Deployable microservices
...
├── _liquibase/                       # Database migration scripts
├── _swagger/                         # OpenAPI specifications
